...
#Should figure out about making a frame counter and rathern than .wait() ing I could just let a certain number of frames pass, still accepting input, just no moves allowed. Or make a "next" button...
#I seem to have some bug with whether they player 0 has passed or not. Especially it seems towards the end.
